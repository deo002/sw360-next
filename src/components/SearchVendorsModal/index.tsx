...
export default function SearchVendorsModalComponent({ chooseVendor }: Props) : JSX.Element {
    ...
    const columns: ColumnType<Vendor>[] = [
        {
          key: "fullName",
          title: "Full Name",
          isSortable: true,
      ...
      const rows: Vendor[] = [
        ...
        },
        {
            fullName: "Akashdeep",
            shortName: "akas2104",
            url: "https://github.com/akas2104"
        }
      ];

      const table: Table< Vendor > = {
        data: rows,
        columns,
        messageOnEmptyTable: "Please perform a new search.",
        paginationSize: 10
      };
